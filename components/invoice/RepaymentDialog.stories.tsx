...
const meta: Meta<typeof RepaymentDialog> = {
  title: "Invoice/RepaymentDialog",
  component: RepaymentDialog,
  parameters: {
    layout: "centered",
  },
};
...
export default meta;
type Story = StoryObj<typeof RepaymentDialog>;
...
export const InsufficientBalanceWarning: Story = {
  args: {
    open: true,
    invoice: mockInvoice,
    isLoading: false,
